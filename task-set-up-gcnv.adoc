...
summary: NetAppコンソールには、Google Cloud NetApp Volumes API へのアクセスと、Google Cloud サービス アカウントを介した適切な権限が必要です。 
---
...
[role="lead"]
NetAppコンソールには、Google Cloud サービス アカウントを介した適切な権限が必要です。



== サービスアカウントを設定する

NetAppコンソールが Google Cloud プロジェクトにアクセスできるように、次のタスクを完了します。
